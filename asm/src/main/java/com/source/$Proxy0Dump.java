...
public class $Proxy0Dump implements Opcodes {
    ...
    public static byte[] dump() throws Exception {
        ...
        cw.visit(52, ACC_PUBLIC + ACC_SUPER, "com/source/$Proxy0", null, "java/lang/reflect/Proxy", new String[]{"com/source/Foo"});
        ...
        }
        {
            ...
            Label l2 = new Label();
            mv.visitLabel(l2);
            mv.visitLocalVariable("this", "Lcom/source/$Proxy0;", null, l0, l2, 0);
        ...
        }
        {
            ...
            mv.visitVarInsn(ALOAD, 0);
            mv.visitFieldInsn(GETFIELD, "com/source/$Proxy0", "h", "Ljava/lang/reflect/InvocationHandler;");
            mv.visitVarInsn(ALOAD, 0);
            mv.visitFieldInsn(GETSTATIC, "com/source/$Proxy0", "foo", "Ljava/lang/reflect/Method;");
            ...
            mv.visitLocalVariable("this", "Lcom/source/$Proxy0;", null, l0, l5, 0);
            mv.visitMaxs(4, 2);
            mv.visitEnd();
        }
        {
            ...
            mv.visitLdcInsn(Type.getType("Lcom/source/Foo;"));
            mv.visitLdcInsn("foo");
            mv.visitInsn(ICONST_0);
            mv.visitTypeInsn(ANEWARRAY, "java/lang/Class");
            mv.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "getMethod", "(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;", false);
            mv.visitFieldInsn(PUTSTATIC, "com/source/$Proxy0", "foo", "Ljava/lang/reflect/Method;");
            mv.visitLabel(l1);
